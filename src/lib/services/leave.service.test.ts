...
function testLeaveDayCalculations() {
  ...
  const days1 = calculateWorkingDays(start1, end1);
  ...
  const days3 = calculateWorkingDays(start3, end3);
  ...
  const days4 = calculateWorkingDays(start4, end4);
  ...
  const days5 = calculateWorkingDays(start5, end5);
